...
namespace CpPartOne.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            // FindTeacher(id) returns teacher object
            Teacher teacher = contoller.FindTeacher(id);

            // passing it to edit view, so by using teacher model
            // we can populate data in form
            return View(teacher);
        }

        // GET: Teacher/Update/{id}
        public ActionResult Update(int id, String teacherFirstName, String teacherLastName, String employeeNumber, DateTime teacherHireDate, decimal teacherSalary)
        {
            ...
            // Capturing data from request 
            String updatedTeacherFirstName = teacherFirstName;
            String updatedTeacherLastName = teacherLastName;
            String updatedTeacherEmployeeNumber = employeeNumber;
            DateTime updatedTeacherHireDate = teacherHireDate;
            decimal updatedTeacherSalary = teacherSalary;

            // creating object of teacher to add the data 
            Teacher updatedTeacher = new Teacher();

            // adding captured data to teacher's object
            updatedTeacher.TeacherFname = updatedTeacherFirstName;
            updatedTeacher.TeacherLname = updatedTeacherLastName;
            updatedTeacher.EmployeeNumber = updatedTeacherEmployeeNumber;
            updatedTeacher.HireDate = updatedTeacherHireDate;
            updatedTeacher.Salary = updatedTeacherSalary;

            // FindTeacher(id) returns teacher object
            int result = contoller.Update(id, updatedTeacher);
