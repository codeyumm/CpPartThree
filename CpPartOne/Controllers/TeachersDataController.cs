...
namespace CpPartOne.Controllers
{
    ...
    public class TeachersDataController : ApiController
    {
        ...
        /// <summary>
        /// Update existing teacher's info to database
        /// </summary>
        /// <param name="id">
        /// Id of teacher that will be updated in database
        /// </param>
        /// <returns>
        /// </returns>

        [HttpPost]
        [Route("api/teachersdata/update/{id}")]
        ...
        public int Update(int id, Teacher teacher)
        {
            ...
            // QUERY - for testing in 
            /// UPDATE teachers
            /// SET teacherfname = "Sean", teacherlname = "Sean", employeenumber = "N235", hiredate = "2023-11-30 00:00:00", salary = "56.74" WHERE teacherid = 3;


            // writing query in command
            cmd.CommandText = "UPDATE teachers SET teacherfname = @TecherFirstName, teacherlname = @TeacherLastName, employeenumber = @EmployeeNumber, hiredate = @HireDate, salary = @Salary WHERE teacherid = @id;";
